...
+ Weekly, but only 3/4 counted, so first one ‘didn’t really count’
+ Non submissions did go up highly for the last one

Feedback:

+ Anticipated Skills were recognised as improved
+ Also highlighted (unanticipated by tutor)
  + Enjoyment / Rewarding / More freedom

Visual editing included ‘turning the phone around to point at computer screen’

Video logs were ‘more personal’ and ‘waffling’ was more readily apparent when students watched themselves

Unexpected *benefits* for students with disabilities, such as dyslexia.

Task required more from tutor as well as students 
+ Logs took longer than written assignment because of the need to prepare the script, and the timing never quite worked out
  + One student had 98 takes!
+ Harder to avoid mistakes or avoid repetition
+ Upload time (youtube/dropbox) was long 

24 hour for general feedback, 1 week for personal feedback
+ Time-consuming (25k words of feedback in total)

Students felt marks were roughly comparable (or better) than written logs.
